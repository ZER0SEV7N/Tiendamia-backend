...
public class CarritoService {
    ...
    // Metodo para obtener el carrito usando el correo del usuario autenticado por
    // JWT
    ...
    public CarritoResponse convertirDto(Carrito carrito) {
        ...
        for (CarritoDetalle detalle : carrito.getDetalles()) {
            ...
            item.setVariacion(detalle.getVariacion().getProducto().getNombre() + " - "
                    + detalle.getVariacion().getProducto().getDescripcion());
