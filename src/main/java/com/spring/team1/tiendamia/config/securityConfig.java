...
public class securityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http.cors(cors -> cors.configurationSource(corsConfigurationSource())) // Aplica las reglas CORS de abajo
            ...
            // Le dice a Spring que no guarde estados en sesión de servidor (porque usamos JWTs)
            ...
            // Agrega tu filtro personalizado (JwtFilter) justo antes del filtro por defecto de Spring
